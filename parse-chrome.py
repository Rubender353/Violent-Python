#From chapter 3 where you create parse-firefox.py to parse the firefox sqlite databases. Here i have added code that allows me to
#parse the databases in chrome, for cookies, downloads, history, and google search history
#!/usr/bin/python
# -*- coding: utf-8 -*-
